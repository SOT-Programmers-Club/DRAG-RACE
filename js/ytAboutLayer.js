var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			"KPRO software copyright 2021 All rights reserved",
			"GamePRO© by KPRO",
			"",
			"To be honest, the material is from the Internet. We will put this game down",
			"  if we get complaints about copyright of the internet so we are free for talks on intellectual",
			"  property",
			"",
			"Made by HTML5"
		];
